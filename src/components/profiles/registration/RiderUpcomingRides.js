...
/**
 * Upcoming Rides for Riders
 * @class RiderUpcomingRides
 */
class RiderUpcomingRides extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
     ...
     */
     /** NK -  Change accomodation to rides table **/
    handleChange(event) {
    ...
    render() {
        return (
            <Card>
                <Card.Header>
                    <h5 style={{float:"left"}}>Rider Upcoming Rides</h5>
                </Card.Header>
                <Card.Body>
...
export default connect(mapStateToProps, mapDispatchToProps)(RiderUpcomingRides);
